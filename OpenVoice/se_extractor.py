...
def split_audio_whisper(audio_path, audio_name, target_dir='processed'):
    ...
    if model is None:
        ...
        model = WhisperModel(model_fp, device="cuda", compute_type="float32")
...
# def split_audio_vad(audio_path, audio_name, target_dir, split_seconds=10.0, model_path='./'):
...
# def get_se(audio_path, vc_model, target_dir='processed', vad=True, model_path='./'):
def get_se(audio_path, vc_model, target_dir='processed', vad=True):
    ...
    if os.path.isdir(audio_path):
        ...
        # wavs_folder = split_audio_vad(audio_path, target_dir=target_dir, audio_name=audio_name, model_path=model_path)
